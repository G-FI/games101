...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    // auto E1=v1-v0,E2=v2-v0,S=ray.origin-v0,S1=crossProduct(ray.direction,E2),S2=crossProduct(S,E1);
    // double tnear=dotProduct(S2,E2)/dotProduct(S1,E1);
    // auto u=dotProduct(S1,S)/dotProduct(S1,E1);
    // auto v=dotProduct(S2,ray.direction)/dotProduct(S1,E1);
    // if(u <0 || v <0 && u + v > 1)
    //     return inter;
    // if(t_tmp < 0)
    //     return inter;
